import {MyFormData} from '@/app/contact/page';
...
export async function POST(request: NextRequest) {
    try {
        ...
        const formData: MyFormData = body.formData;
        ...
        const mailOptions = {
            ...
            replyTo: email,
            subject: `Someone Contacted You - Gett Funded`,
            html: `
    <!DOCTYPE html>
    <html>
      <head>
      ...
      ">
        ...
        ">
          ...
          <div style="
            ...
            color: #718096;
          ">
            This email was sent from the Gett Funded contact form.
          </div>
        </div>
      </body>
    </html>
